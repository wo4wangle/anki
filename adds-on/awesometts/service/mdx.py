...
MAPPINGS = [
    ('br', "British English", 'english', [re.compile(BASE_PATTERN % r'r')]),
    ('us', "American English", 'french-english', [re.compile(BASE_PATTERN % r'b')])
]
...
class Mdx(Service):
    ...
    def desc(self):
        ...
        return "LDOCE 6 on MDX Server(%d languages)." \
